                           ...
                           <span class="flex justify-between">
                                   ...
                                   @click.prevent="$emit('edit', row)">
                                    <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                 content="Edit" v-tippy="{ arrow: true, animation: 'fade', placement: 'top-start', arrow: true, interactive: true}"
                                            >
                                ...
                                <a v-if="deletable" href="#" class="text-warning hover:text-warning-dark"
                                   @click.prevent="$emit('delete', row)">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                             content="Delete" v-tippy="{ arrow: true, animation: 'fade', placement: 'top-start', arrow: true, interactive: true}"
                                        >
                                ...
                                <a v-if="viewable" href="#" class="text-secondary hover:text-secondary-dark"
                                   @click.prevent="$emit('view', row)">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                             content="View" v-tippy="{ arrow: true, animation: 'fade', placement: 'top-start', arrow: true, interactive: true}"
                                        >
