        ...
        <v-form-label v-bind="labelProps">
            <div class="mt-1 flex rounded-md shadow-sm">
                ...
                >
                    ...
                    <optgroup v-for="(options, group) in groupedSelectOptions" :label="group">
                        <option
...
export default {
    ...
    computed: {
        groupedSelectOptions() {
            ...
            this.selectOptions // Iterate through select options
              .filter((option) => option.group) // Only get those in a group
              .forEach((option) => addOption(option)); // Add as an option
            return groups;
        },
