  ...
  <div class="w-full p-6 mx-auto lg:w-1/3">
    <div class="shadow-xl rounded-xl bg-blueGray-50">
      ...
      <div class="p-4 lg:p-8 bg-blueGray-50">
        ...
        <h2 class="mb-8 text-xs font-semibold tracking-widest text-black uppercase title-font" v-if="subtext">{{ subtext }}</h2>
        <a :href=url class="inline-flex items-center mt-auto font-semibold text-blue-600 lg:mb-0 hover:text-black " :title="'Continue ' + title"> {{ urlString }} </a>
      </div>
...
export default {
  ...
  props: {
    ...
    urlString: { type: String, required: false, default: "Continue Task" },
